...
Function Main {
    ...
    $User = Get-AutomationVariable -Name ClientID
    $Pass = Get-AutomationVariable -Name ClientSecret
    ...
    Try {
        $AuthToken = Get-AuthToken -TenantID $TenantID -user $clientId -Pass $ClientSecret
    }
    Catch {
